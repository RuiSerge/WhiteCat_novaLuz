...
const char file_arduino_kalman_param[24]= {"arduino_Kalman.whc"}; //
unsigned int arduino_kalman_param_size=128*3;//double kalman_params[3][analog_limit];
const char file_arduino_kalman_on[24]= {"arduino_Kalman_on.whc"}; //
unsigned int arduino_kalman_on_size=12;//bool kalman_is_on[analog_limit];
...
//WAVE
const char file_wave_ch_slots[24]= {"wave_channels.whc"};
int wave_ch_slots_size=26*4;//int channel_slots[4][26];
const char file_wave_brush_slots[24]= {"wave_brush.whc"};
int wave_brush_slots_size=26*4;//float brush_slots[4][26];
const char file_wave_brush_pr[24]= {"wave_brush_pr.whc"};
int wave_brush_pr_size=4;//int lead_brush_reading[4];
const char file_wave_damp_decay[24]= {"wave_dampers.whc"};
int wave_damp_decay_size=2;//2 float delte et decay reporté sur les 26
////////////////////////////////////////////////////////////////////////////////
/**
...
int load_draw_preset_config()
{
    ...
    else
    {
        ...
        for(int i=0; i<6; i++)
        {
            ...
            if(draw_damper_decay_factor[i]>1.0)
            {
                draw_damper_decay_factor[i]=1.0;
            }
...
//Damper
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_damper_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_damper_on);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_damper_typ);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_damper_typ);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",  file_fader_damper_levels);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_fader_damper_levels);
                b_report_error[idf]=1;
            }
...
//grid affectation
    ...
    if(specify_who_to_save_load[18]==1)  ////////////MIDI cheat midi ///////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_midi_clock);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",file_midi_clock);
                b_report_error[idf]=1;
            }
    ...
    if(specify_who_to_save_load[21]==1)  //ARDUINO//////////////////////////////////////////////////////////
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_arduino_an_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_arduino_an_on);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_arduino_kalman_param);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_arduino_kalman_param);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s",file_arduino_kalman_on);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s",  file_arduino_kalman_on);
                b_report_error[idf]=1;
            }
...
//WAVE
    if(specify_who_to_save_load[34]==1)
    {
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_wave_ch_slots);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_wave_ch_slots);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_wave_brush_slots);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_wave_brush_slots);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_wave_brush_pr);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_wave_brush_pr);
                b_report_error[idf]=1;
            }
        ...
        {
            sprintf(string_save_load_report[idf],"Error opening file %s", file_wave_damp_decay);
            b_report_error[idf]=1;
        }
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error writting %s", file_wave_damp_decay);
                b_report_error[idf]=1;
            }
...
//DAMPER faders
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_damper_on);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_damper_typ);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_fader_damper_levels);
                b_report_error[idf]=1;
            }
...
//midi_init_sepecial_case_key_on();
    ...
    if(specify_who_to_save_load[18]==1) /////////////MIDI cheat///////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s",   file_midi_clock);
                b_report_error[idf]=1;
            }
...
//position player
    ...
    if(specify_who_to_save_load[21]==1)///ARDUINO////////////////////////////////////
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_an_on);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_kalman_param);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_arduino_kalman_on);
                b_report_error[idf]=1;
            }
...
//WAVE
    if(specify_who_to_save_load[34]==1)
    {
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_wave_ch_slots);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_wave_brush_slots);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_wave_brush_pr);
                b_report_error[idf]=1;
            }
        ...
        else
        {
            ...
            {
                sprintf(string_save_load_report[idf],"Error Loaded %s", file_wave_damp_decay);
                b_report_error[idf]=1;
            }
