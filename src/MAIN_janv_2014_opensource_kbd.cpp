...
//pour whitecat solo
//allegro 4 #include <allegro.h>
//allegro 4 #include <winalleg.h>
//allegro 4 #include <OpenLayer.hpp>
#include <windows.h>
...
//allegro 4 #include <loadpng.h>
#include <assert.h>
#include <Iphlpapi.h>
#include <audiere.h>

//allegro 4 #include <jpgalleg.h>
...
ALLEGRO_TIMER * timer_dmx = NULL; // allegro 4 int ticker_dmxIn_rate = BPS_TO_TIMER(dmxINrate);
ALLEGRO_TIMER * timer_bps = NULL; // allegro 4 int ticker_rate = BPS_TO_TIMER(BPS_RATE);
ALLEGRO_TIMER * timer_midi = NULL; // allegro 4 int ticker_dmxIn_rate = BPS_TO_TIMER(dmxINrate);
ALLEGRO_TIMER * timer_artnet = NULL; // allegro 4 int ticker_dmxIn_rate = BPS_TO_TIMER(dmxINrate);
...
// -- en attendant qu'il y ait un fichier des déclarations des fonctions globales
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// sab 08/2016 - HOT KEYS -- ANCRAGE : si le service est inactif, hk_manager passe la main à commandes_clavier()     ///////                             ///////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//sprintf(string_debug,"%d",arduino_max_digital);
        ...
        if(index_show_chrono==1)
        {
            show_foreground_chrono(xtime_window+115,ytime_window-80);
        }
